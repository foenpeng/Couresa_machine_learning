...
for i = 1:num_labels
 J = J + (1/m)*sum(-Y(:,i).*log(a2(:,i))-(1-Y(:,i)).*log(1-a2(:,i)));
end
...
for i = 1:m
    ...
    a2 = sigmoid(z2);
    a2m = [1 a2];
    z3 = a2m*transpose(Theta2);
    a3 = sigmoid(z3);
    %a3 = (a3 == max(a3));
    sigma3 = a3 - Y(i,:);
    sigma2 = (transpose(Theta2(:,2:end))*transpose(sigma3)).*transpose(sigmoidGradient(z2));   
    delta2 = delta2 + transpose(sigma3) * a2m;
